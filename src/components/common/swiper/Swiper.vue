<template>
  <div id="hy-swiper">
    ...
    <div name="indicator">
      <slot class="indicator" v-if="showIndicator&& slideCount>1">
...
export default {
  ...
  methods: {
    ...
    handleDom: function () {
      ...
      let slidersEls = swiperEl.getElementsByClassName('slider');
      /**
       * 2.保存个数
       */
      ...
      if (this.slideCount > 1) {
        ...
        swiperEl.insertBefore(cloneFirst, slidersEls[0]);
